    ...
    <div class="page text-center">
      ...
      <section class="breadcrumb-classic context-dark">
        <div class="shell section-30 section-sm-top-70 section-sm-bottom-60">
          <h1 class="veil reveal-sm-block">EMSA E-Library</h1>
                  ...
                  <?php
                    ...
                    while($row = $query->fetch_assoc()){ ?>
                        <div class="cell-sm-6 offset-top-30">
                            <article class="post-news"><a href="news-post-page.php"><img
                                        src="admin/images/materials_images/<?php echo $row['photo'] ?>" width="370" height="240" alt=""
                                        class="img-responsive"></a>
                                <div class="post-news-body">
                                    <h6><a href="news-post-page.php"><?php echo $row['name'] ?></a></h6>
                                    <div class="offset-top-20">
                                        <p>Click on the link below to download file on your device</p>
                                    </div>
                                    <div data-caption-animate="fadeInUp" data-caption-delay="400"
                                    <?php
                                      $file = $row['file'];
                                    ?>
                                        class="offset-top-20 offset-xl-top-40"><a href="download.php?file=<?php echo $row['file'] ?>"
...
<!-- Mirrored from www.stlouis.edu.hk/SL90/grid-news.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Apr 2021 10:40:19 GMT -->
</html>