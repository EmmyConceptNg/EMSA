...
<!-- Mirrored from www.stlouis.edu.hk/SL90/header-minimal.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Apr 2021 10:39:24 GMT -->
<head>
    <!-- Site Title-->
    <title>Header Minimal, Footer Center</title>
    <meta charset="utf-8">
    ...
    <div class="page text-center">
      ...
      <header class="page-head header-panel-absolute">
        ...
        <div class="rd-navbar-wrap">
          <nav data-md-device-layout="rd-navbar-static" data-lg-device-layout="rd-navbar-static" data-stick-up-offset="159" data-xl-stick-up-offset="34" class="rd-navbar rd-navbar-minimal" data-lg-auto-height="true" data-auto-height="false" data-md-layout="rd-navbar-static" data-lg-layout="rd-navbar-static" data-lg-stick-up="true">
      ...
      <main class="page-content">
                    ...
                    <div class="range range-xs-center range-lg-left">
                      <div class="cell-md-9 text-md-left cell-xs-10">
                        <div data-caption-animate="fadeInUp" data-caption-delay="100">
                          <h1 class="text-bold"><a href="academic.php">Inspiration, Innovation and Discovery.</a></h1>
                        </div>
                        ...
                        <div data-caption-animate="fadeInUp" data-caption-delay="400" class="offset-top-20 offset-xl-top-20"><a href="login-register.php" class="btn btn-primary">Sign Up for Excursion</a>
                ...
                <div class="swiper-slide-caption">
                  <div class="container">
                    <div class="range range-xs-center range-lg-left">
                      <div class="cell-md-9 text-md-left cell-xs-10">
                        <div data-caption-animate="fadeInUp" data-caption-delay="100">
                          <h1 class="text-bold"><a href="academic.php">Investing in Knowledge.</a></h1>
                        </div>
                        <div data-caption-animate="fadeInUp" data-caption-delay="150" class="offset-top-20 offset-xs-top-40 offset-xl-top-60 inset-lg-right-100">
                          <h5>Any successful career starts with good education. Together with us you will have deeper knowledge of the subjects that will be especially useful for you when climbing the career ladder.</h5>
                        </div>
                ...
                <div class="swiper-slide-caption">
                  <div class="container">
                    <div class="range range-xs-center range-lg-left">
                      <div class="cell-md-9 text-md-left cell-xs-10">
                        <div data-caption-animate="fadeInUp" data-caption-delay="100">
                          <h1 class="text-bold"><a href="academic.php">Open Minds. <br class="veil reveal-md-inline-block"> Creating Futures.</a></h1>
                        </div>
                        <div data-caption-animate="fadeInUp" data-caption-delay="150" class="offset-top-20 offset-xs-top-40 offset-xl-top-60 inset-lg-right-100">
                          <h5>Any successful career starts with good education. Together with us you will have deeper knowledge of the subjects that will be especially useful for you when climbing the career ladder.</h5>
                        </div>
        ...
        <section class="bg-catskill">
          <div class="shell section-70 section-md-114">
            ...
            <div class="range offset-top-60 text-left range-xs-center">
              <div class="cell-sm-6 cell-md-4">
                ...
                <div class="offset-top-30">
                  <article class="post-news"><a href="news-post-page.php"><img src="images/blog/news-04-370x240.jpg" width="370" height="240" alt="" class="img-responsive"></a>
                    <div class="post-news-body">
                      <h6><a href="news-post-page.php">
              ...
              <div class="cell-sm-6 cell-md-4 offset-top-30 offset-sm-top-0">
                ...
                <div class="offset-top-30">
                  <article class="post-news"><a href="news-post-page.php"><img src="images/blog/news-05-370x240.jpg" width="370" height="240" alt="" class="img-responsive"></a>
                    <div class="post-news-body">
                      <h6><a href="news-post-page.php">
              ...
              <div class="cell-sm-12 cell-md-4 offset-top-30 offset-md-top-0">
                <div class="range">
                  ...
                  <div class="cell-sm-6 cell-md-12 offset-top-30 offset-sm-top-0 offset-md-top-30">
                    <article class="post-news"><a href="news-post-page.php"><img src="images/blog/news-06-370x240.jpg" width="370" height="240" alt="" class="img-responsive"></a>
                      <div class="post-news-body">
                        <h6><a href="news-post-page.php">Studying in the United States</a></h6>
                        <div class="offset-top-20">
            ...
            <div class="offset-top-50"><a href="grid-news-3-columns.php" class="btn btn-primary">View All News Posts</a></div>
          </div>
        </section>
      </main>
      <!-- Corporate footer-->
      <footer class="section-60 page-footer section-bottom-30">
        <div class="shell">
          <!--Footer brand--><a href="index.php" class="reveal-inline-block"><img src="images/logo-170x172.png" width="70" height="70" alt="" class="img-responsive reveal-inline-block">
            <div class="offset-top-10">
              <h6 class="barnd-name text-ubold">Jonathan Carroll</h6>
            </div>
            <div>
          ...
          <div class="offset-top-45">
            <p class="text-dark">&copy; <span id="copyright-year"></span> All Rights Reserved Terms of Use and <a href="privacy.php" class="text-dark">Privacy Policy</a></p>
          </div>
        </div>
      </footer>
    </div>
