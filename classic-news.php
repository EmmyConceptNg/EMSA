...
<!-- Mirrored from www.stlouis.edu.hk/SL90/classic-news.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Apr 2021 10:40:02 GMT -->
<head>
    <!-- Site Title-->
    ...
    <div class="page text-center">
      ...
      <section class="breadcrumb-classic context-dark">
        <div class="shell section-30 section-sm-top-70 section-sm-bottom-60">
          <h1 class="veil reveal-sm-block">Classic news</h1>
          ...
          <div class="shell">
            <div class="range range-xs-center">
              <div class="cell-md-8 text-md-left">
                <article class="post-news post-news-wide"><a href="news-post-page.php"><img src="images/blog/news-01-770x500.jpg" width="770" height="500" alt="" class="img-responsive"></a>
                  <div class="post-news-body">
                    <h4 class="text-primary text-bold"><a href="news-post-page.php">Liberal Arts Colleges Rankings</a></h4>
                    <div class="offset-top-20">
                      <p>The National Liberal Arts Colleges, including schools like Wellesley College and Bowdoin College, emphasize undergraduate education and award at least half of their degrees in the liberal arts fields of study.</p>
                    </div>
                    <div class="offset-top-20">
                      <ul class="post-news-meta list list-inline list-inline-xl">
                        ...
                        <li class="pull-lg-right reveal-block offset-top-20 offset-lg-top-10">
                          <div class="tags-list group group-sm"><a href="news-post-page.php" class="btn btn-xs btn-primary text-italic">News</a><a href="news-post-page.php" class="btn btn-xs btn-primary text-italic">Colleges</a><a href="news-post-page.php" class="btn btn-xs btn-primary text-italic">Liberal Arts</a></div>
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div class="offset-top-30">
                  <article class="post-news post-news-wide"><a href="news-post-page.php"><img src="images/blog/news-06-770x500.jpg" width="770" height="500" alt="" class="img-responsive"></a>
                    <div class="post-news-body">
                      <h4 class="text-primary text-bold"><a href="news-post-page.php">Studying in the United States</a></h4>
                      <div class="offset-top-20">
                ...
                <div class="offset-top-30">
                  <article class="post-news post-news-wide"><a href="news-post-page.php"><img src="images/blog/news-03-770x500.jpg" width="770" height="500" alt="" class="img-responsive"></a>
                    <div class="post-news-body">
                      <h4 class="text-primary text-bold"><a href="news-post-page.php">5 Ways to Pay for Community College</a></h4>
                      <div class="offset-top-20">
                ...
                <div class="offset-top-30">
                  <article class="post-news post-news-wide"><a href="news-post-page.php"><img src="images/blog/news-05-770x500.jpg" width="770" height="500" alt="" class="img-responsive"></a>
                    <div class="post-news-body">
                      <h4 class="text-primary text-bold"><a href="news-post-page.php">Consider MBA Programs That Offer Summer Prep</a></h4>
                      <div class="offset-top-20">
              ...
              <div class="cell-md-4 text-left cell-xs-8 offset-top-85 offset-md-top-0">
                <aside class="inset-md-left-30">
                  ...
                  <div class="offset-top-30">
                                      <!-- RD Search Form-->
                                      <form action="http://www.stlouis.edu.hk/SL90/search-results.php" method="GET" class="form-search rd-search form-search-widget">
                                        <div class="form-group">
                  ...
                  <div class="offset-top-60">
                    ...
                    <div class="offset-top-20 text-left">
                                        <div data-photo-swipe-gallery="" data-flickr-tags="59029" class="flickr widget-flickrfeed"><a data-photo-swipe-item="" href="#" data-image_c="href" data-size="800x800" data-type="flickr-item" class="thumbnail-default"><img width="170" height="170" data-title="alt" src="images/_blank.png" alt="" data-image_q="src"><span class="icon fa-search-plus"></span></a><a data-photo-swipe-item="" href="#" data-image_c="href" data-size="800x800" data-type="flickr-item" class="thumbnail-default"><img width="170" height="170" data-title="alt" src="images/_blank.png" alt="" data-image_q="src"><span class="icon fa-search-plus"></span></a><a data-photo-swipe-item="" href="#" data-image_c="href" data-size="800x800" data-type="flickr-item" class="thumbnail-default"><img width="170" height="170" data-title="alt" src="images/_blank.png" alt="" data-image_q="src"><span class="icon fa-search-plus"></span></a><a data-photo-swipe-item="" href="#" data-image_c="href" data-size="800x800" data-type="flickr-item" class="thumbnail-default"><img width="170" height="170" data-title="alt" src="images/_blank.png" alt="" data-image_q="src"><span class="icon fa-search-plus"></span></a><a data-photo-swipe-item="" href="#" data-image_c="href" data-size="800x800" data-type="flickr-item" class="thumbnail-default"><img width="170" height="170" data-title="alt" src="images/_blank.png" alt="" data-image_q="src"><span class="icon fa-search-plus"></span></a><a data-photo-swipe-item="" href="#" data-image_c="href" data-size="800x800" data-type="flickr-item" class="thumbnail-default"><img width="170" height="170" data-title="alt" src="images/_blank.png" alt="" data-image_q="src"><span class="icon fa-search-plus"></span></a>
                                        </div>
                    </div>
                  </div>
                  <div class="offset-top-60">
                    ...
                    <div class="offset-top-20">
                      <ul class="list list-marked list-marked-primary">
                        ...
                        <li><a href="news-post-page.php">University</a></li>
                  ...
                  <div class="offset-top-60">
                    ...
                    <div class="offset-top-20 text-left">
                      <article class="widget-post">
                        <h6 class="text-bold text-primary"><a href="news-post-page.php">Ways Parents and Counselors Can Help Students Earn Scholarships</a></h6>
                        <p class="text-dark">2 days ago by Ronald Austin</p>
                      </article>
                      <div class="offset-top-20">
                        <article class="widget-post">
                          <h6 class="text-bold text-primary"><a href="news-post-page.php">10 Law Schools Where the Most Accepted Students Enroll</a></h6>
                          <p class="text-dark">2 days ago by Ronald Austin</p>
                        </article>
                      </div>
                      <div class="offset-top-20">
                        <article class="widget-post">
                          <h6 class="text-bold text-primary"><a href="news-post-page.php">Consider MBA Programs That Offer Summer Prep</a></h6>
                          <p class="text-dark">2 days ago by Ronald Austin</p>
                        </article>
                      </div>
                    </div>
                  ...
                  <div class="offset-top-60">
                    ...
                    <div class="text-subline"></div>
                    <div class="offset-top-20">
                      <div class="tags-list group group-sm reveal-inline-block text-middle"><a href="news-post-page.php" class="btn btn-xs btn-primary text-italic">News</a><a href="news-post-page.php" class="btn btn-xs btn-primary text-italic">Colleges</a><a href="news-post-page.php" class="btn btn-xs btn-primary text-italic">Liberal Arts</a><a href="news-post-page.php" class="btn btn-xs btn-primary text-italic">University</a><a href="news-post-page.php" class="btn btn-xs btn-primary text-italic">Education</a><a href="news-post-page.php" class="btn btn-xs btn-primary text-italic">Blog</a></div>
                    </div>
                  </div>
                </aside>
              </div>
...
<!-- Mirrored from www.stlouis.edu.hk/SL90/classic-news.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Apr 2021 10:40:19 GMT -->
</html>