...
<!-- Mirrored from www.stlouis.edu.hk/SL90/tabs-and-accordions.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Apr 2021 10:38:39 GMT -->
<head>
    <!-- Site Title-->
    ...
    <div class="page text-center">
      ...
      <section class="breadcrumb-classic context-dark">
        <div class="shell section-30 section-sm-top-70 section-sm-bottom-60">
          <h1 class="veil reveal-sm-block">Tabs &amp; Accordions</h1>
      ...
      <main class="page-content section-70 section-md-114">
          ...
          <div class="shell">
            <div class="range range-xs-center">
              <div class="cell-xs-10 cell-lg-8">
                <h2 class="text-bold">Classic Tabs</h2>
                ...
                <div class="offset-top-50">
                  ...
                  <div data-type="horizontal" class="responsive-tabs responsive-tabs-classic horizontal">
                    ...
                    <div data-group="tabs-group-default" class="resp-tabs-container text-sm-left tabs-group-default">
                      ...
                      <div>
                        <p>Their work transforms the way we understand the world, advancing and creating fields of study.</p>
                      </div>
                      <div>
                        <p>Our scholars lead the country in scientific and technological innovations, often in partnership with our affiliated laboratories: Argonne National Laboratory, Fermi National Accelerator Laboratory, and the Marine Biological Laboratory in Woods Hole, Massachusetts.</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="shell">
            <div class="range range-xs-center">
              <div class="cell-xs-10 cell-lg-12">
                <h2 class="text-bold">Classic Vertical Tabs</h2>
                <hr class="divider bg-madison">
        ...
        <section class="offset-top-70 offset-md-top-114">
          <div class="shell">
            <div class="range range-xs-center">
              <div class="cell-xs-10 cell-lg-8">
                <h2 class="text-bold">Button Tabs</h2>
                <hr class="divider bg-madison">
                <div class="offset-top-60">
                  <!-- Responsive-tabs-->
        ...
        <section class="offset-top-70 offset-md-top-114">
          <div class="shell">
            <div class="range range-xs-center">
              <div class="cell-xs-10 cell-lg-12">
                <h2 class="text-bold">Button Vertical Tabs</h2>
                <hr class="divider bg-madison">
                <div class="offset-top-60">
                  <!-- Responsive-tabs-->
        ...
        <section class="offset-top-70 offset-md-top-114">
          <div class="shell">
            <div class="range range-xs-center">
              <div class="cell-xs-10 cell-lg-8">
                <h2 class="text-bold">Classic Accordion</h2>
                <hr class="divider bg-madison">
                <div class="offset-top-60">
                  <!-- Classic Accordion-->
                  <div data-type="accordion" class="responsive-tabs responsive-tabs-classic">
                    <ul data-group="tabs-group-default" class="resp-tabs-list tabs-group-default">
                      <li>How much does it cost to attend the University?</li>
                      <li>How do I apply to University? </li>
                      <li>What kind of financial aid do you offer? </li>
                      <li>Can I enroll in online learning classes or programs? </li>
                    </ul>
                    <div data-group="tabs-group-default" class="resp-tabs-container tabs-group-default">
                      <div>
                        <p>Graduate and professional admissions are handled individually by each of University's 12 graduate and professional schools. Visit the site of the school you wish to attend for information.</p>
                      </div>
                      <div>
                        <p>Graduate and professional admissions are handled individually by each of University's 12 graduate and professional schools. Visit the site of the school you wish to attend for information.</p>
                      </div>
        ...
        <section class="offset-top-70 offset-md-top-114">
          <div class="shell">
            <div class="range range-xs-center">
              <div class="cell-xs-10 cell-lg-8">
                <h2 class="text-bold">Modern Accordion</h2>
                <hr class="divider bg-madison">
                <div class="offset-top-60">
                  <!-- Classic Accordion-->
                  <div data-type="accordion" class="responsive-tabs responsive-tabs-classic">
