        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="admin_add.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="position" class="col-sm-3 control-label">User Type</label>

                    <div class="col-sm-9">
                      <select class="form-control" id="position" name="user_type" required>
                          <option value="">...</option>
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="admin_edit.php">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <select class="form-control" id="edit_position" name="user_type" required>
                      <option value="">...</option>
                      <option value="admin">Admin</option>
                      <option value="executive">Executive</option>
                      <option value="imsec">IMSEC</option>
