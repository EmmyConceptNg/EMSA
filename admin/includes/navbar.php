<header class="main-header">
  ...
  <a href="#" class="logo">
    ...
    <span class="logo-mini"><b>EMSA</b></span>
    <!-- logo for regular state and mobile devices -->
    <span class="logo-lg"><b>EMSA</b>-Unilorin</span>
  </a>
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown user user-menu">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            <img src="<?php echo (!empty($user['avatar'])) ? 'images/admin/'.$user['avatar'] : 'images/admin/profile.jpg'; ?>" class="user-image" alt="User Image">
