    ...
    <section class="content">
      ...
      <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-aqua">
          ...
          <a href="all_posts.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
        </div>
      </div>
      <!-- ./col -->
      <?php } ?>
      ...
      <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-red">
          ...
          <a href="executive.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
        </div>
      </div>
      <!-- ./col -->
      <?php } ?>
      ...
      <?php if($_SESSION['admin_type'] !== 'executive'){ ?>
        <div class="col-lg-3 col-xs-6">
          <!-- small box -->
          <div class="small-box bg-red">
            <div class="inner">
              <?php
                $sql = "SELECT * FROM imsec";
                $query = $conn->query($sql);
            ...
            <a href="imsec.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <?php } ?>
