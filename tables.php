...
<!-- Mirrored from www.stlouis.edu.hk/SL90/tables.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Apr 2021 10:38:39 GMT -->
<head>
    <!-- Site Title-->
    <title>Tables</title>
    <meta charset="utf-8">
    ...
    <div class="page text-center">
      ...
      <section class="breadcrumb-classic context-dark">
        <div class="shell section-30 section-sm-top-70 section-sm-bottom-60">
          <h1 class="veil reveal-sm-block">Tables</h1>
      ...
      <main class="page-content section-70 section-md-114">
        ...
        <section>
          <div class="shell">
            <h2 class="text-bold">Hover Rows Table</h2>
            <hr class="divider bg-madison">
            <div class="range offset-sm-top-45 range-xs-center">
        ...
        <section class="offset-top-70 offset-md-top-114">
          <div class="shell">
            <h2 class="text-bold">Striped Table</h2>
            <hr class="divider bg-madison">
            <div class="range offset-sm-top-45 range-xs-center">
              <div class="cell-sm-10 cell-lg-8">
                <!-- Classic Responsive Table-->
        ...
        <section class="offset-top-70 offset-md-top-114">
          <div class="shell">
            <h2 class="text-bold">Dark Header, Hover Rows</h2>
            <hr class="divider bg-madison">
            <div class="range offset-sm-top-60 range-xs-center">
              <div class="cell-sm-10 cell-lg-8">
                <!-- Classic Responsive Table-->
        ...
        <!-- Condenced Table Table-->
        <section class="offset-top-70 offset-md-top-114">
          <div class="shell">
            <h2 class="text-bold">Condensed Table</h2>
            <hr class="divider bg-madison">
            <div class="range offset-sm-top-50 range-xs-center">
              <div class="cell-sm-10 cell-lg-8">
                <!-- Classic Responsive Table-->
                <table data-responsive="true" class="table table-custom table-fixed condensed-table">
                  <tr>
                    <th>#</th>
                    <th>First Name</th>
                    <th>Last Name</th>
        ...
        <section class="offset-top-70 offset-md-top-114">
          <div class="shell">
            <h2 class="text-bold">Bordered Table</h2>
            <hr class="divider bg-madison">
            <div class="range offset-sm-top-50 range-xs-center">
              <div class="cell-sm-10 cell-lg-8">
                <!-- Classic Responsive Table-->
