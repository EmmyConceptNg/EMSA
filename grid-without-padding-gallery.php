...
<!-- Mirrored from www.stlouis.edu.hk/SL90/grid-without-padding-gallery.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Apr 2021 10:42:35 GMT -->
<head>
    <!-- Site Title-->
    <title>Grid Without Padding Gallery</title>
    <meta charset="utf-8">
        ...
        <div class="shell section-30 section-sm-top-70 section-sm-bottom-60">
          ...
          <div class="offset-sm-top-35">
            <ul class="list-inline list-inline-lg list-inline-dashed p">
              ...
              <li>Grid Without Padding Gallery
              </li>
            </ul>
          </div>
        </div>
          ...
          <div class="shell">
            ...
            <div class="offset-top-60">
              <div data-photo-swipe-gallery="gallery" class="range range-xs-center range-lg-condensed">
                ...
                <div class="cell-xs-10 cell-sm-6 cell-md-4 offset-top-30 offset-lg-top-0">
                  <figure class="thumbnail-classic">
