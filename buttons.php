...
<!-- Mirrored from www.stlouis.edu.hk/SL90/buttons.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Apr 2021 10:38:39 GMT -->
<head>
    <!-- Site Title-->
    <title>Buttons</title>
    <meta charset="utf-8">
    ...
    <div class="page text-center">
      ...
      <section class="breadcrumb-classic context-dark">
        <div class="shell section-30 section-sm-top-70 section-sm-bottom-60">
          <h1 class="veil reveal-sm-block">Buttons</h1>
      ...
      <main class="page-content section-70 section-md-114">
          ...
          <div class="shell">
            <div class="range range-xs-center range-sm-left">
              <div class="cell-xs-12">
                <h2 class="text-bold">Button Sizes</h2>
                <hr class="divider bg-madison">
                <div class="offset-top-40 offset-md-top-60">
                  <div class="group group-xl"><a href="#" class="btn btn-primary">Standard Button</a><a href="#" class="btn btn-primary btn-sm">Small Button</a></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <section class="offset-top-70 offset-md-top-114">
          <div class="shell">
            <h2 class="text-bold">Button Shapes</h2>
            <hr class="divider bg-madison">
            <div class="offset-top-40 offset-md-top-60">
              <div class="group group-xl"><a href="#" class="btn btn-primary"> Default Shape</a><a href="#" class="btn btn-primary btn-round"> Round Shape</a><a href="#" class="btn btn-primary btn-ellipse">Circle Shape</a><a href="#" class="btn btn-primary btn-rect">Square Shape</a></div>
            </div>
          </div>
          <section class="offset-top-70 offset-md-top-114">
            <div class="shell">
              <h2 class="text-bold">Buttons with Icons</h2>
              <hr class="divider bg-madison">
              <div class="offset-top-40 offset-md-top-60">
                <div class="group group-xl"><a href="#" class="btn btn-icon btn-icon-right btn-default"><span class="icon fa-arrow-right"></span><span>Learn More</span></a><a href="#" class="btn btn-icon btn-icon-left btn-default"><span class="text-middle icon fa-arrow-right"></span><span>Read More</span></a><a href="#" class="btn btn-primary btn-icon btn-icon-left"><span class="icon fa-arrow-right"></span><span>Read More</span></a><a href="#" class="btn btn-icon btn-icon-right btn-primary"><span class="icon fa-arrow-right"></span><span>Learn More</span></a></div>
              </div>
            </div>
          </section>
          <section class="offset-top-70 offset-md-top-114">
            <div class="shell">
              <h2 class="text-bold">Buttons without Shadow</h2>
              <hr class="divider bg-madison">
              <div class="offset-top-40 offset-md-top-60">
                <div class="group group-xl"><a href="#" class="btn btn-icon btn-icon-right btn-default btn-shadow-none"><span class="icon fa-arrow-right"></span><span>Learn More</span></a><a href="#" class="btn btn-icon btn-icon-right btn-primary btn-shadow-none"><span class="icon fa-arrow-right"></span><span>Learn More</span></a></div>
              </div>
            </div>
          </section>
          <section class="offset-top-70 offset-md-top-114">
            <div class="shell">
              <h2 class="text-bold">Social Buttons</h2>
              <hr class="divider bg-madison">
              <div class="offset-top-40 offset-md-top-60">
