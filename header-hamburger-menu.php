...
<!-- Mirrored from www.stlouis.edu.hk/SL90/header-hamburger-menu.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Apr 2021 10:39:24 GMT -->
<head>
    <!-- Site Title-->
    <title>Header Hamburger Menu</title>
    <meta charset="utf-8">
    ...
    <div class="page text-center">
      ...
      <header style="position:absolute; left:0; right:0;top:0" class="page-head">
        ...
        <div class="rd-navbar-wrap">
          <nav data-lg-auto-height="true" data-md-layout="rd-navbar-fixed" data-md-device-layout="rd-navbar-fixed" data-lg-layout="rd-navbar-fixed" data-lg-device-layout="rd-navbar-fixed" data-lg-stick-up="false" data-lg-hover-on="false" class="rd-navbar rd-navbar-humburger-menu" data-auto-height="false">
                ...
                <div class="rd-navbar-nav-wrap">
                  <div class="rd-navbar-mobile-scroll">
                    ...
                    <ul class="rd-navbar-nav">
                      ...
                      <li><a href="shopping-cart.php">Shopping Cart (2)</a></li>
                    </ul>
      ...
      <main class="page-content">
        ...
        <section>
          <div class="shell-wide section-70 section-md-114">
                    ...
                    <div class="unit-body">
                      <div class="post-event-body text-lg-left">
                        ...
                        <ul class="list-inline list-inline-xs">
                          <li><a href="team-member-profile.php" class="icon icon-xxs mdi mdi-account-outline text-middle"></a></li>
                          <li>
                            <div class="text-dark text-middle">Walter Stanley</div>
                          </li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div class="unit-body">
                      <div class="post-event-body text-lg-left">
                        ...
                        <ul class="list-inline list-inline-xs">
                          <li><a href="team-member-profile.php" class="icon icon-xxs mdi mdi-account-outline text-middle"></a></li>
                          <li>
                            <div class="text-dark text-middle">Raymond Salazar</div>
                          </li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div class="unit-body">
                      <div class="post-event-body text-lg-left">
                        ...
                        <ul class="list-inline list-inline-xs">
                          <li><a href="team-member-profile.php" class="icon icon-xxs mdi mdi-account-outline text-middle"></a></li>
                          <li>
                            <div class="text-dark text-middle">Bruce Hawkins</div>
                          </li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div class="unit-body">
                      <div class="post-event-body text-lg-left">
                        ...
                        <ul class="list-inline list-inline-xs">
                          <li><a href="team-member-profile.php" class="icon icon-xxs mdi mdi-account-outline text-middle"></a></li>
                          <li>
                            <div class="text-dark text-middle">Danielle Garza</div>
                          </li>
                        </ul>
                      </div>
                    </div>
            ...
            <div class="offset-top-50 offset-lg-top-56"><a href="calendar.php" class="btn btn-icon btn-icon-right btn-primary"><span class="icon fa-arrow-right"></span><span>View Event Calendar</span></a></div>
          </div>
        </section>
      </main>
      <!-- Corporate footer-->
