...
<!-- Mirrored from www.stlouis.edu.hk/SL90/grid-news-3-columns.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Apr 2021 10:40:19 GMT -->
<head>
    <!-- Site Title-->
    <title>3 Columns Grid News</title>
    <meta charset="utf-8">
    ...
    <div class="page text-center">
      ...
      <section class="breadcrumb-classic context-dark">
        <div class="shell section-30 section-sm-top-70 section-sm-bottom-60">
          <h1 class="veil reveal-sm-block">3 Columns Grid News</h1>
          <div class="offset-sm-top-35">
            <ul class="list-inline list-inline-lg list-inline-dashed p">
              <li><a href="index.php">Home</a></li>
              <li><a href="#">News</a></li>
              <li>3 Columns Grid News
              </li>
            </ul>
          </div>
        </div>
          ...
          <div class="shell">
            <div class="range text-sm-left range-xs-center">
              <div class="cell-sm-6 cell-md-4">
                <article class="post-news post-news-wide"><a href="news-post-page.php"><img src="images/blog/news-01-370x240.jpg" width="700" height="455" alt="" class="img-responsive"></a>
              ...
              <div class="cell-sm-6 cell-md-4 offset-top-30 offset-sm-top-0">
                <article class="post-news post-news-wide"><a href="news-post-page.php"><img src="images/blog/news-02-370x240.jpg" width="700" height="455" alt="" class="img-responsive"></a>
                  <div class="post-news-body">
              ...
              <div class="cell-sm-6 cell-md-4 offset-top-30 offset-md-top-0">
                <article class="post-news post-news-wide"><a href="news-post-page.php"><img src="images/blog/news-04-370x240.jpg" width="700" height="455" alt="" class="img-responsive"></a>
                  <div class="post-news-body">
              ...
              <div class="cell-sm-6 cell-md-4 offset-top-30">
                <article class="post-news post-news-wide"><a href="news-post-page.php"><img src="images/blog/news-03-370x240.jpg" width="700" height="455" alt="" class="img-responsive"></a>
                  <div class="post-news-body">
              ...
              <div class="cell-sm-6 cell-md-4 offset-top-30">
                <article class="post-news post-news-wide"><a href="news-post-page.php"><img src="images/blog/news-05-370x240.jpg" width="700" height="455" alt="" class="img-responsive"></a>
                  <div class="post-news-body">
                    <h6><a href="news-post-page.php">
              ...
              <div class="cell-sm-6 cell-md-4 offset-top-30">
                <article class="post-news post-news-wide"><a href="news-post-page.php"><img src="images/blog/news-06-370x240.jpg" width="700" height="455" alt="" class="img-responsive"></a>
                  <div class="post-news-body">
...
<!-- Mirrored from www.stlouis.edu.hk/SL90/grid-news-3-columns.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Apr 2021 10:40:20 GMT -->
</html>