...
<!-- Mirrored from www.stlouis.edu.hk/SL90/shopping-cart.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Apr 2021 10:43:48 GMT -->
<head>
    <!-- Site Title-->
        ...
        <section>
          <div class="shell">
                ...
                <table class="table-dark-blue table-custom table">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><a href="single-product.php" class="text-primary">Five Star Advance Spiral Notebook Standard Size</a></td>
                      <td>$29.00</td>
                      <td>
                    ...
                    <tr>
                      <td class="text-center p"><a href="#" class="icon fa-trash icon-xxs text-gray"></a></td>
                      <td><a href="single-product.php" class="text-primary">Diesel T-Diego Fr</a></td>
                      <td>$9.00</td>
                      <td>
                        <input type="number" data-zeros="true" value="1" min="1" max="20" class="form-control input-sm">
                      </td>
            ...
            <div class="offset-top-20 text-sm-left">
              ...
              </div><a href="checkout.php" class="btn btn-primary btn-icon btn-icon-right pull-sm-right offset-top-10 offset-sm-top-0"><span class="icon fa-arrow-right"></span><span>Checkout</span></a>
            </div>
          </div>
        </section>
      </main>
