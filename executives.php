    ...
    <div class="page text-center">
      ...
      <section class="breadcrumb-classic context-dark">
        <div class="shell section-30 section-sm-top-70 section-sm-bottom-60">
          <h1 class="veil reveal-sm-block">Executives</h1>
                  ...
                  <?php
                    ...
                    while($row = $query->fetch_assoc()){ ?>
                        ...
                        <figure class="thumbnail-classic">
                            <div class="thumbnail-classic-img-wrap"><img width="370" height="370" src="admin/images/executives/<?php echo $row['avatar'] ?>" alt=""/><a class="gallery-link-mobile veil-lg" data-photo-swipe-item="" data-size="1200x800" href="images/portfolio/gallery-01-1200x800_original.jpg"></a></div>
                            <figcaption class="thumbnail-classic-caption text-center">
                            <div>
                                <h4 class="thumbnail-classic-title"><?php echo $row['username'] ?></h4>
                            </div>
                            <hr class="divider divider-sm"/>
                            <p>Executive President</p>
                            <div class="offset-top-20 veil reveal-lg-block"><a class="icon icon-xxs fa-search-plus" data-photo-swipe-item="" data-size="1200x800" href="admin/images/executives/<?php echo $row['avatar'] ?>"></a></div>
                            </figcaption>
                        </figure>
                        </div>
                <?php } ?>
