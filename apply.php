...
<!-- Mirrored from www.stlouis.edu.hk/SL90/apply.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Apr 2021 10:39:16 GMT -->
<head>
    <!-- Site Title-->
    <title>Apply</title>
    <meta charset="utf-8">
    ...
    <div class="page text-center">
      ...
      <section class="breadcrumb-classic context-dark">
        <div class="shell section-30 section-sm-top-70 section-sm-bottom-60">
          <h1 class="veil reveal-sm-block">Apply</h1>
      ...
      <main class="page-content">
        ...
        <section class="section-70 section-md-114">
          <div class="shell">
            <div class="range">
              <div class="cell-sm-4 cell-sm-push-2 text-sm-left"><img src="images/apply-01-370x370.jpg" width="370" height="370" alt="" class="img-responsive reveal-inline-block"></div>
              <div class="cell-sm-8 cell-sm-push-1 offset-top-50 offset-sm-top-0 text-sm-left">
                <div class="inset-sm-right-30">
                  <h2 class="text-bold">How to Apply</h2>
        ...
        <section class="bg-madison">
          <div class="shell">
            <div class="range range-xs-center range-sm-right offset-top-0">
              <div class="cell-xs-10 cell-sm-8 cell-md-6 section-image-aside section-image-aside-left text-sm-left">
                <div style="background-image: url(images/apply-02-948x987.jpg)" class="section-image-aside-img veil reveal-sm-block section-image-aside-2-img"></div>
                <div class="section-image-aside-body section-70 section-md-114 inset-sm-left-70 inset-lg-left-100">
                  <h2 class="text-bold text-white">Fill in the Form</h2>
                  ...
                  <div class="offset-top-60">
                    <form data-form-output="form-output-global" data-form-type="contact" method="post" action="http://www.stlouis.edu.hk/SL90/bat/rd-mailform.php" class="rd-mailform text-left">
                      <div class="offset-top-17">
                        <div class="form-group">
                          <label for="fill-form-name" class="form-label form-label-outside text-white">First name</label>
                          <input id="fill-form-name" type="text" name="name" data-constraints="@Required" class="form-control">
                        </div>
                      </div>
                      <div class="offset-top-17">
                        <div class="form-group">
                          <label for="fill-form-last-name" class="form-label form-label-outside text-white">Last name</label>
                          <input id="fill-form-last-name" type="text" name="last-name" data-constraints="@Required" class="form-control">
                        </div>
                      </div>
                      <div class="offset-top-17">
                        <div class="form-group">
                          <label for="fill-form-phone" class="form-label form-label-outside text-white">Phone</label>
                          <input id="fill-form-phone" type="text" name="phone" data-constraints="@Required @IsNumeric" class="form-control">
                        </div>
                      </div>
                      <div class="offset-top-17">
                        <div class="form-group">
                          <label for="fill-form-email" class="form-label form-label-outside text-white">E-mail</label>
                          <input id="fill-form-email" type="email" name="email" data-constraints="@Required @Email" class="form-control">
                        </div>
                      </div>
                      <div class="offset-top-17">
                        <div class="form-group">
                          <label for="fill-form-department" style="color: #fff" class="form-label form-label-outside">Department</label>
                          <select id="fill-form-department" data-placeholder="Law" data-minimum-results-for-search="Infinity" class="form-control select-filter">
                            <option>Law</option>
                      ...
                      <div class="offset-top-35">
                        <div class="form-group">
                          <!-- RD Filepicker-->
                          <div id="fill-form-file" class="rd-file-picker">
                      ...
                      <div class="text-center text-lg-left offset-top-30 context-dark">
...
<!-- Mirrored from www.stlouis.edu.hk/SL90/apply.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Apr 2021 10:39:24 GMT -->
</html>