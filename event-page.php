...
<!-- Mirrored from www.stlouis.edu.hk/SL90/event-page.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Apr 2021 10:40:01 GMT -->
<head>
    <!-- Site Title-->
    ...
    <div class="page text-center">
      ...
      <section class="breadcrumb-classic context-dark">
        <div class="shell section-30 section-sm-top-70 section-sm-bottom-60">
          <h1 class="veil reveal-sm-block">Event Page</h1>
          ...
          <div class="shell">
            <div class="range range-xs-center">
              <div class="cell-sm-6 text-left">
                <div class="inset-sm-right-30"><img src="images/event-01-540x540.jpg" width="540" height="540" alt="" class="img-responsive reveal-inline-block">
                  ...
                  <div class="offset-top-20 text-center text-xs-left">
                    <div class="unit unit-xs unit-xs-horizontal unit-spacing-lg">
                      <div class="unit-left"><img src="images/users/user-walter-myers-110x110.jpg" width="110" height="110" alt="" class="img-responsive reveal-inline-block img-rounded"></div>
                      <div class="unit-body">
                        <h6 class="text-bold text-primary">Walter Myers</h6>
                        <div class="offset-sm-top-30">
                          <ul class="list list-unstyled">
                            <li><span class="icon icon-xs mdi mdi-phone text-middle"></span><a href="callto:#" class="reveal-inline-block text-black inset-left-10">1-800-1234-567</a></li>
                            <li><span class="icon icon-xs mdi mdi-email-outline text-middle"></span><a href="mailto:info@demolink.org" class="reveal-inline-block inset-left-10">info@demolink.org</a></li>
                          </ul>
                        </div>
                      </div>
                    </div>
                    <div class="offset-top-20">
                      <p>Walter has been involved in graphic design education for over 10 years. He is a passionate designer and design educator, believing that what matters above all else is a great idea executed appropriately and brilliantly.</p>
                    </div>
                  </div>
                </div>
              </div>
              <div class="cell-sm-6 text-left offset-top-50 offset-sm-top-0">
                <h2 class="text-bold">Graphic Design <br class="veil reveal-sm-inline-block"> Workshop</h2>
                <div class="hr divider bg-madison hr-left-0"></div>
                <div class="offset-top-30 offset-sm-top-60">
                  <p>A picture paints a thousand words. So if you're planning on pursuing a career in graphic design, you'd better make sure you know what you're saying.</p>
                  <p>This four-day workshop introduces you to the principles of design, exploring the role of colour, shape and form. You'll get expert advice on portfolio preparation and create pieces in InDesign.</p>
                </div>
                <div class="offset-top-30 offset-sm-top-60">
                ...
                <div class="offset-top-17">
                  ...
                  <ul class="list list-unstyled">
                    <li><span class="text-black">Date:</span> <span>Thursday 14th April</span>
                    </li>
                    <li><span class="text-black">Times:</span> <span>9.30am - 3.30pm</span>
                    </li>
                    <li><span class="text-black">Fee:</span> <span>$120</span>
                    </li>
                    <li><span class="text-black">Location:</span> <span>1 Fitzwilliam Street, Parramatta  - JCU's College of Design & Commerce Campus</span>
                    </li>
                  </ul>
                  <div class="offset-top-30 offset-sm-top-60">
                  ...
                  <div class="offset-top-20">
                    ...
                    <p>If you'd like to enroll, download and complete this form, and then e-mail it to mail@demolink.org with the subject line "JCU 2016 Workshop".</p>
                  </div>
            ...
            <div class="range offset-top-60 range-xs-center">
              <div class="cell-sm-6 cell-md-5 cell-xl-3">
                <article class="post-event">
                  <div class="post-event-img-overlay"><img src="images/blog/event-05-420x420.jpg" width="420" height="420" alt="" class="img-responsive">
              ...
              <div class="cell-sm-6 cell-md-5 cell-xl-3 offset-top-50 offset-sm-top-0">
                <article class="post-event">
                  <div class="post-event-img-overlay"><img src="images/blog/event-06-420x420.jpg" width="420" height="420" alt="" class="img-responsive">
                    <div class="post-event-overlay context-dark"><a href="apply.php" class="btn btn-primary">Book Now</a>
                      <div class="offset-top-20"><a href="event-page.php" class="btn btn-default">Learn More</a></div>
                    </div>
                  </div>
              ...
              <div class="cell-sm-6 cell-md-5 cell-xl-3 offset-top-50 offset-xl-top-0">
                <article class="post-event">
                  <div class="post-event-img-overlay"><img src="images/blog/event-07-420x420.jpg" width="420" height="420" alt="" class="img-responsive">
                    <div class="post-event-overlay context-dark"><a href="apply.php" class="btn btn-primary">Book Now</a>
                      <div class="offset-top-20"><a href="event-page.php" class="btn btn-default">Learn More</a></div>
                    </div>
                  </div>
              ...
              <div class="cell-sm-6 cell-md-5 cell-xl-3 offset-top-50 offset-xl-top-0">
                <article class="post-event">
                  <div class="post-event-img-overlay"><img src="images/blog/event-08-420x420.jpg" width="420" height="420" alt="" class="img-responsive">
                    <div class="post-event-overlay context-dark"><a href="apply.php" class="btn btn-primary">Book Now</a>
                      <div class="offset-top-20"><a href="event-page.php" class="btn btn-default">Learn More</a></div>
                    </div>
                  </div>
                  <div class="unit unit-lg unit-lg-horizontal">
                    ...
                    <div class="unit-body">
                      <div class="post-event-body text-lg-left">
                        <h6><a href="event-page.php">NASA Schedules News Conference About Next Space Shuttle Launch</a></h6>
                        <ul class="list-inline list-inline-xs">
                          <li><a href="team-member-profile.php"><span class="icon icon-xxs mdi mdi-account-outline text-middle"></span><span class="inset-left-10 text-dark text-middle">Walter Stanley</span></a></li>
                        </ul>
                      </div>
        ...
        <div class="shell section-60">
          <div class="range range-lg-justify range-xs-center">
            <div class="cell-md-3 cell-lg-2">
              <!--Footer brand--><a href="index.php"><img width='170' height='172' src='images/logo-170x172.png' alt=''/></a>
              <div>
                <h6 class="barnd-name text-bold offset-top-25">Jonathan Carroll</h6>
              </div>
              <div>
                <p class="brand-slogan text-dark text-italic">University</p>
              </div>
            </div>
                ...
                <ul class="list-unstyled contact-info list">
                  <li>
                    <div class="unit unit-horizontal unit-middle unit-spacing-xs">
                      ...
                      <div class="unit-body"><a href="callto:#" class="text-dark">1-800-1234-567,<br class="veil-md">1-800-6547-321</a></div>
                    </div>
                  </li>
...
<!-- Mirrored from www.stlouis.edu.hk/SL90/event-page.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Apr 2021 10:40:02 GMT -->
</html>