...
<!-- Mirrored from www.stlouis.edu.hk/SL90/footer-minimal.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Apr 2021 10:39:24 GMT -->
<head>
    <!-- Site Title-->
  ...
  <body>
    ...
    <div class="page text-center">
        ...
        <section>
          ...
          <div data-height="42.1875%" data-loop="true" data-dragable="false" data-min-height="480px" data-slide-effect="true" class="swiper-container swiper-slider">
            <div class="swiper-wrapper">
              <div data-slide-bg="images/slide-01-1920x810.jpg" style="background-position: center center" class="swiper-slide">
              ...
              <div data-slide-bg="images/slide-02-1920x810.jpg" style="background-position: center center" class="swiper-slide">
                <div class="swiper-slide-caption">
                  <div class="container">
                    <div class="range range-xs-center range-lg-left">
                      <div class="cell-md-9 text-md-left cell-xs-10">
              ...
              <div data-slide-bg="images/slide-03-1920x810.jpg" style="background-position: center center" class="swiper-slide">
                <div class="swiper-slide-caption">
                  <div class="container">
                    <div class="range range-xs-center range-lg-left">
                      <div class="cell-md-9 text-md-left cell-xs-10">
      ...
      <!-- Corporate footer-->
      <footer class="section-60 page-footer">
        <div class="shell">
          <div class="range range-xs-center range-sm-middle text-md-left">
            <div class="cell-xs-10 cell-md-6">
              <!--Footer brand--><a href="index.php" class="reveal-inline-block">
                <div class="unit unit-xs-middle unit-md unit-md-horizontal unit-spacing-xxs">
                  <div class="unit-left"><img src="images/logo-170x172.png" width="70" height="70" alt="" class="img-responsive reveal-inline-block"></div>
                  <div class="unit-body text-xl-left">
                    <div>
