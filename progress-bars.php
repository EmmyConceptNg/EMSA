...
<!-- Mirrored from www.stlouis.edu.hk/SL90/progress-bars.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Apr 2021 10:38:39 GMT -->
<head>
    <!-- Site Title-->
    ...
    <div class="page text-center">
      ...
      <section class="breadcrumb-classic context-dark">
        <div class="shell section-30 section-sm-top-70 section-sm-bottom-60">
          <h1 class="veil reveal-sm-block">Progress bars</h1>
      ...
      <main class="page-content section-70 section-md-114">
        ...
        <section>
          <div class="shell">
            <h2 class="text-bold">Counters</h2>
            ...
            <div class="range range-xs-center range-md-left offset-top-65 counters">
              ...
              <div class="cell-sm-6 cell-md-3 offset-top-65 offset-md-top-0">
                ...
                <div class="counter-type-1"><span class="icon icon-lg icon-outlined text-madison mdi mdi-account-multiple-outline"></span>
                  <div class="h3 text-bold text-primary offset-top-15"><span data-step="500" data-from="0" data-to="3510" class="counter"></span></div>
                  <hr class="divider bg-gray-light divider-sm"/>
                  <div class="offset-top-10">
        ...
        <section class="offset-top-70 offset-md-top-114">
          <div class="shell">
            <h2 class="text-bold">Classic Skill Bars</h2>
            <hr class="divider bg-madison">
            <div class="range range-xs-center offset-top-65">
              <div class="cell-xs-10 cell-sm-6">
                <div class="clearfix">
                  ...
                  <div data-to="70" class="progress-linear">
                    <div class="progress-header clearfix">
                      <div class="text-left">
                        <h6 class="text-bold pull-left text-black">Law</h6>
                ...
                <div class="offset-top-56 clearfix">
                  <!-- Linear progress bar-->
                  <div data-to="42" class="progress-linear">
                    <div class="progress-header clearfix">
                      <div class="text-left">
                        <h6 class="text-bold pull-left text-black">Mathematics</h6>
                ...
                <div class="offset-top-56 clearfix">
                  <!-- Linear progress bar-->
                  <div data-to="38" class="progress-linear">
                    <div class="progress-header clearfix">
                      <div class="text-left">
                        <h6 class="text-bold pull-left text-black">Physics</h6>
                ...
                <div class="offset-top-56 clearfix">
                  <!-- Linear progress bar-->
                  <div data-to="94" class="progress-linear">
                    <div class="progress-header clearfix">
                      <div class="text-left">
                        <h6 class="text-bold pull-left text-black">Computer Science</h6>
        ...
        <!-- Modern Skills Bars-->
        <section class="offset-top-90 offset-md-top-114">
          <div class="shell">
            <h2 class="text-bold">Modern Skill Bars</h2>
            <hr class="divider bg-madison">
                ...
                <div class="clearfix">
                  ...
                  <div class="progress-linear">
                    <div class="progress-header clearfix">
                      <div class="text-left">
                        <h6 class="text-bold pull-left text-black">Law</h6>
                      </div><span class="text-bold pull-right progress-size">70</span>
                    </div>
                    <div class="progress-bar-linear-wrap offset-top-5">
                      <div class="progress">
                        <div role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style=" width: 70%;" class="progress-bar progress-bar-primary progress-bar-striped"><span class="sr-only">70%</span></div>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="offset-top-56 clearfix">
                  ...
                  <div class="progress-linear">
                    <div class="progress-header clearfix">
                      <div class="text-left">
                        <h6 class="text-bold pull-left text-black">Mathematics</h6>
                      </div><span class="text-bold pull-right progress-size">87</span>
                    </div>
                    <div class="progress-bar-linear-wrap offset-top-5">
                      <div class="progress">
                        <div role="progressbar" aria-valuenow="87" aria-valuemin="0" aria-valuemax="100" style=" width: 87%;" class="progress-bar progress-bar-primary progress-bar-striped"><span class="sr-only">87%</span></div>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="offset-top-56 clearfix">
                  ...
                  <div class="progress-linear">
                    <div class="progress-header clearfix">
                      <div class="text-left">
                        <h6 class="text-bold pull-left text-black">Physics</h6>
                      </div><span class="text-bold pull-right progress-size">36</span>
                    </div>
                    <div class="progress-bar-linear-wrap offset-top-5">
                      <div class="progress">
                        <div role="progressbar" aria-valuenow="36" aria-valuemin="0" aria-valuemax="100" style=" width: 36%;" class="progress-bar progress-bar-primary progress-bar-striped"><span class="sr-only">36%</span></div>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="offset-top-56 clearfix">
                  ...
                  <div class="progress-linear">
                    <div class="progress-header clearfix">
                      <div class="text-left">
                        <h6 class="text-bold pull-left text-black">Computer Science</h6>
                      </div><span class="text-bold pull-right progress-size">58</span>
                    </div>
                    <div class="progress-bar-linear-wrap offset-top-5">
                      <div class="progress">
                        <div role="progressbar" aria-valuenow="58" aria-valuemin="0" aria-valuemax="100" style=" width: 58%;" class="progress-bar progress-bar-primary progress-bar-striped"><span class="sr-only">58%</span></div>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <!-- progress Bars-->
        <section class="offset-top-85 offset-md-top-133">
          <div class="shell">
            <h2 class="text-bold">Classic Progress Bar</h2>
            <hr class="divider bg-madison">
            <div class="range range-xs-center offset-top-60 text-center">
              <div class="cell-sm-6 cell-md-3">
                <!-- Circle Progress bar-circle-->
                <div data-value="1" data-gradient="#0d2d62" data-empty-fill="#e5e5e5" data-size="130" class="progress-bar-circle"><span></span></div>
                <div class="offset-top-20">
                  <h6 class="text-bold">Law</h6>
                </div>
              </div>
              <div class="cell-sm-6 offset-top-50 cell-md-3 offset-sm-top-0">
                <!-- Circle Progress bar-circle-->
                <div data-value="0.5" data-gradient="#0d2d62" data-empty-fill="#e5e5e5" data-size="130" class="progress-bar-circle"><span></span></div>
                <div class="offset-top-20">
                  <h6 class="text-bold">Mathematics</h6>
                </div>
              </div>
              <div class="cell-sm-6 offset-top-50 cell-md-3 offset-md-top-0">
                <!-- Circle Progress bar-circle-->
                <div data-value="0.25" data-gradient="#0d2d62" data-empty-fill="#e5e5e5" data-size="130" class="progress-bar-circle"><span></span></div>
                <div class="offset-top-20">
              ...
              <div class="cell-sm-6 offset-top-50 cell-md-3 offset-md-top-0">
                <!-- Circle Progress bar-circle-->
                <div data-value="0.75" data-gradient="#0d2d62" data-empty-fill="#e5e5e5" data-size="130" class="progress-bar-circle"><span></span></div>
                <div class="offset-top-20">
                  <h6 class="text-bold">Computer Sciene</h6>
                </div>
              </div>
            </div>
          </div>
        ...
        <section class="offset-top-85 offset-md-top-133">
          <div class="shell">
            <h2 class="text-bold">Modern Progress Bar</h2>
            <hr class="divider bg-madison">
            <div class="range range-xs-center offset-top-60 text-center">
              <div class="cell-sm-6 cell-md-3">
                <!-- Circle Progress bar-circle-->
                <div data-value="1" data-gradient="#b80924" data-thickness="10" data-empty-fill="#e5e5e5" data-size="130" class="progress-bar-circle progress-bar-modern"><span></span></div>
                <div class="offset-top-20">
                  <h6 class="text-bold">Law</h6>
                </div>
              </div>
              <div class="cell-sm-6 offset-top-50 cell-md-3 offset-sm-top-0">
                <!-- Circle Progress bar-circle-->
                <div data-value="0.5" data-gradient="#b80924" data-thickness="10" data-empty-fill="#e5e5e5" data-size="130" class="progress-bar-circle progress-bar-modern"><span></span></div>
                <div class="offset-top-20">
                  <h6 class="text-bold">Mathematics</h6>
                </div>
              </div>
              <div class="cell-sm-6 offset-top-50 cell-md-3 offset-md-top-0">
                <!-- Circle Progress bar-circle-->
                <div data-value="0.25" data-gradient="#b80924" data-thickness="10" data-empty-fill="#e5e5e5" data-size="130" class="progress-bar-circle progress-bar-modern"><span></span></div>
                <div class="offset-top-20">
                  <h6 class="text-bold">Physics</h6>
                </div>
              </div>
              <div class="cell-sm-6 offset-top-50 cell-md-3 offset-md-top-0">
                <!-- Circle Progress bar-circle-->
                <div data-value="0.75" data-gradient="#b80924" data-thickness="10" data-empty-fill="#e5e5e5" data-size="130" class="progress-bar-circle progress-bar-modern"><span></span></div>
                <div class="offset-top-20">
                  <h6 class="text-bold">Computer Sciene</h6>
                </div>
              </div>
