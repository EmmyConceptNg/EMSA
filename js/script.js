  ...
  if (plugins.swiper.length) {
    plugins.swiper.each(function () {
      ...
      s.find(".swiper-slide")
          ...
          .end()
          .swiper({
            autoplay: s.attr('data-swiper-autoplay') ? s.attr('data-swiper-autoplay') : false,
...
/*tat*/
if(plugins.spritespin.length){
	$.getScript("js/spritespin/page.js", function(){
		$.getScript("js/spritespin/spritespin.js", function(){
