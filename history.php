    ...
    <div class="page text-center">
      ...
      <section class="breadcrumb-classic context-dark">
        <div class="shell section-30 section-sm-top-70 section-sm-bottom-60">
          <h1 class="veil reveal-sm-block">History</h1>
          ...
          <div class="shell">
            <div class="range">
              <div class="cell-sm-4 cell-sm-push-2 text-sm-left">
                <div class="inset-sm-left-30"><img
                    src="admin/images/executives/eyelashes-logo-icon-design-template-vector-png_301833.jpg" width="340"
                    height="300" alt="" class="img-responsive reveal-inline-block img-rounded">
                  <div class="offset-top-20">
                    <h6 class="text-primary text-bold">Kolaowle Emmanuel</h6>
                  </div>
                  <p>Longest Serving President of Educational Management 2019 - 2021.</p>
                </div>
              </div>
              <div class="cell-sm-8 cell-sm-push-1 offset-top-50 offset-sm-top-0 text-sm-left">
                ...
                <div class="offset-top-30 offset-sm-top-60">
                  <p>History of the Department Goes Here....</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="shell">
            <div class="range range-xs-center range-sm-left">
              <div class="cell-sm-8 text-sm-left">
                ...
                <hr class="divider bg-madison hr-sm-left-0">
                <div class="offset-top-30 offset-sm-top-60">
                  <p>Mission of the Departmenty goes here...</p>
                </div>
              </div>
            </div>
          </div>
...
<!-- Mirrored from www.stlouis.edu.hk/SL90/history.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Apr 2021 10:39:31 GMT -->
</html>